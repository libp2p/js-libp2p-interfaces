...
describe('peer-store', () => {
  ...
  describe('previously populated books', () => {
    ...
    it('has peers', async () => {
      ...
      expect(peers.map(peer => peer.id.toString(base58btc))).to.have.members([
        peerIds[0].toString(base58btc),
        peerIds[1].toString(base58btc),
        peerIds[2].toString(base58btc),
    ...
    it('deletes a stored peer', async () => {
      ...
      expect(Array.from(peers.keys())).to.not.have.members([peerIds[0].toString(base58btc)])
    })
    ...
    it('gets the stored information of a peer in all its books', async () => {
      ...
      expect(peer.id.toString(base58btc)).to.equal(peerIds[0].toString(base58btc))
    })
    ...
    it('can find all the peers supporting a protocol', async () => {
      ...
      expect(peerSupporting2[0].id.toString(base58btc)).to.eql(peerIds[1].toString(base58btc))
      expect(peerSupporting2[1].id.toString(base58btc)).to.eql(peerIds[3].toString(base58btc))
    })
    ...
    it('can find all the peers listening on a given address', async () => {
      ...
      expect(peerListening4[0].id.toString(base58btc)).to.eql(peerIds[2].toString(base58btc))
      expect(peerListening4[1].id.toString(base58btc)).to.eql(peerIds[3].toString(base58btc))
    })
  })
